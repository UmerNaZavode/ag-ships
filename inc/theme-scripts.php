...
function ag_ships_scripts()
{
    ...
    wp_enqueue_script('ag-ships-slick-js', get_template_directory_uri() . '/assets/libs/slick/slick.min.js', array("jquery"), _S_VERSION, true);
    wp_enqueue_script('ag-ships-custom-jquery-js', get_template_directory_uri() . '/assets/js/custom-jquery.js', array("jquery"), _S_VERSION, true);
