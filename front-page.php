                    ...
                    <div class="history__description">
                        <div class="history__info">
                            <p>
                                ...
                                facilisis. Tempus bibendum
                                viverra est vel. Ullamcorper dignissim donec feugiat porta. Interdum neque porttitor
                                ultrices feugiat sit
                                nulla
                                ullamcorper nibh amet. Imperdiet risus gravida tempus suspendisse nulla aliquam est. Sed
                                quis in maecenas
                                vestibulum neque malesuada scelerisque mauris. Pharetra ipsum sapien vestibulum fames.
                                Nisl phasellus
                                pellentesque quam risus non orci.
                            </p>
                            <p>
                                Risus magna mauris massa gravida turpis vestibulum vulputate libero scelerisque. Proin
                                sed quam amet
                                pellentesque rhoncus semper aenean ultrices gravida. Tristique scelerisque lorem sed
                                eget integer sed sed.
                                Leo
                                donec mi sagittis ac adipiscing diam felis quisque diam. Auctor sed vulputate odio non
                                velit amet. At justo
                                porta gravida elementum mi. Neque tellus tellus sit etiam volutpat aliquam tincidunt
                                semper. Nibh lobortis
                                commodo sapien sollicitudin sagittis. Turpis erat amet volutpat urna quis felis. Lorem
                                mi amet dolor dictum.
                                Facilisis dignissim mauris tristique adipiscing molestie eget consectetur nec non. Id
                                elementum nibh
                                faucibus
                                enim pharetra faucibus ultrices neque magnis. At cursus accumsan blandit tellus nisi
                                tincidunt sit. Lacus
                                mattis
                                mattis nunc tincidunt vitae et.
                            </p>
                            <p>
                                Orci augue morbi bibendum ac viverra diam a fermentum. Massa eget porttitor tellus
                                aliquam quisque turpis at
                                nunc. Ut tortor quam urna suscipit. Dictumst neque tincidunt malesuada facilisi cras
                                urna. In nunc sed
                                ultrices
                                eu parturient aliquam. Non lorem facilisis tincidunt est aliquam hac diam. Suspendisse
                                viverra eleifend leo
                                facilisis in. Id purus arcu cursus id. Pretium semper id sit arcu id adipiscing. Neque.
                            </p>
                        </div>
                    </div>
                    <div class="history__path">
                        <img src="/assets/history-BtHVx_hU.svg" width="638" height="406" alt=""
                        ...
                        <div class="history__path-info">
                            <ul class="history__path-list">
                                ...
                                <li class="history__path-item">Scelerisque lorem semper facilisi auctor metus eros in.
                                    Feugiat.
                                </li>
            ...
            <div class="publications__main container">
                ...
                <ul class="publications__list">
                    <li class="publications__item">
                        <img src="/assets/pub-1-DbVM561t.jpg" class="publications__item-img" width="306" height="260"
                             alt="">
                        <p class="publications__item-date" datetime="2022-9-6">6 сентября 2022 Г.</p>
                        <h4 class="publications__item-subtitle">Nibh lacinia venenatis bibendum eget fermentum semper
                            amet. Sed eu
                    ...
                    <li class="publications__item">
                        <img src="/assets/pub-2-ByDGkmPN.jpg" class="publications__item-img" width="306" height="260"
                             alt="">
                        <p class="publications__item-date" datetime="2022-9-6">6 сентября 2022 Г.</p>
                        <h4 class="publications__item-subtitle">Mattis sem habitant non vitae scelerisque. Sagittis
                            eleifend id
                            convallis posuere feugiat nibh sed risus et. Id aliquam enim ut ac nunc porttitor.</h4>
                        <a href="/" class="publications__item-link">Sollicitudin aliquet lorem sed varius a eget
                            quis.</a>
                    </li>
                    <li class="publications__item">
                        <img src="/assets/pub-3-Hd5d2eTD.jpg" class="publications__item-img" width="306" height="260"
                             alt="">
                        <p class="publications__item-date" datetime="2022-9-5">5 сентября 2022 Г.</p>
                        <h4 class="publications__item-subtitle">Sit quis non facilisis posuere. Nec sit auctor nibh
                            integer lacus.
                    ...
                    <li class="publications__item">
                        <img src="/assets/pub-4-CmiJMjvb.jpg" class="publications__item-img" width="306" height="260"
                             alt="">
                        <p class="publications__item-date" datetime="2022-9-6">6 сентября 2022 Г.</p>
                        <h4 class="publications__item-subtitle">Lobortis vitae in tellus ac fames amet. Magna et in nunc
                            suspendisse
                    ...
                    <div class="projects__body">
                        <div class="projects__body-main">
                            ...
                            <div class="projects__body-info">
                                ...
                                <p class="projects__body-description">Fringilla eget auctor non sed viverra mattis.
                                    Lectus est est
                                    ullamcorper
                                    eu natoque vitae mi consequat. Eget ac elit viverra nec donec cras. Nec nunc nisi
                                    augue imperdiet blandit
                        ...
                        <div class="projects__spec">
                            <dl class="projects__spec-list">
                                <div class="projects__spec-item">
                                    <dt class="projects__spec-value"><span
                                                class="projects__spec-value--bold">130 000</span>тон
                                    </dt>
                ...
                <div class="safety__wrapper navigation-btn">
                    ...
                    <div class="safety-content">
                        <div class="safety-content__body">
                            <div class="safety-content__info">
                                ...
                                <ul class="safety-content__list">
                                    <li class="safety-content__item">
                                        <p>
                                            Tincidunt fames porta pretium congue orci cursus. Ut nisl ultrices elit
                                            euismod
                                            tincidunt. Vitae
                                            accumsan tellus lectus viverra id scelerisque. Pellentesque viverra in nibh
                                            a
                                    ...
                                    <li class="safety-content__item">
                                        <p>
                                            Lobortis imperdiet adipiscing commodo ipsum vulputate in at nibh. Diam velit
                                            neque
                                            nisl pellentesque
                                    ...
                                    <li class="safety-content__item">
                                        <p>
                                            Lacinia nunc sagittis arcu lobortis sed arcu suspendisse imperdiet nunc. Eu
                                            nunc
                                            tempor ultrices
                                    ...
                                    <li class="safety-content__item">
                                        <p>
                                            Quisque hac molestie mauris nunc mus nunc. Consequat sed ac integer sed nunc
                                            ut
                                            curabitur tincidunt.
                            ...
                            <img src="/assets/safety-D0g7E52B.jpg" width="480" height="410" alt=""
