...
function ag_ships_setup()
{
    load_theme_textdomain('ag-ships', get_template_directory() . '/languages');
    ...
    add_theme_support(
        'custom-background',
        apply_filters(
            'ag_ships_custom_background_args',
            array(
 ...
 */
function ag_ships_content_width()
{
    $GLOBALS['content_width'] = apply_filters('ag_ships_content_width', 640);
}
add_action('after_setup_theme', 'ag_ships_content_width', 0);
