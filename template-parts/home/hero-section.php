...
<div class="hero-section">
  ...
  <?php foreach ($background_images as $k => $image_url) : ?>
    <img src="<?php echo $image_url; ?>" alt="" width="1920" height="900" class="background-img <?php echo $k === 0 ? 'active show' : ''; ?>">
  <?php endforeach; ?>
  ...
  <div class="hero container">
    ...
    <div class="ship-spec">
      ...
      <img src="<?php echo get_template_directory_uri(); ?>/assets/ship-diagram-DeZbsea4.png" alt="" class="ship-spec__img">
    </div>
  </div>
</div>
